...
- Behavioral decoding from GPFA latent trajectories — `behavioral_decoding.ipynb`
  - NOTE: The decoder itself is cross-validated Ridge regression, mapping the GPFA or VLMD latents to a behavioral variable. I ran it across several behaviors like whisking, pupil area, and respiration, swept across a range of latent dimensionalities, and scored with held-out R².
